  ...
  return (
    <div className="-m-8 p-8 bg-[#F0F4F8] min-h-[calc(100vh-5rem)] font-sans text-[#0F172A]">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <Card className="rounded-xl shadow-sm shadow-blue-900/5 border border-slate-100" bodyStyle={{ padding: '20px' }}>
        ...
        <Card className="rounded-xl shadow-sm shadow-blue-900/5 border border-slate-100 overflow-hidden" bodyStyle={{ padding: 0 }}>
          <Table 
            columns={columns} 
