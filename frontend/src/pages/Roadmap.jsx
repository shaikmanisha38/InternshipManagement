      ...
      <Row gutter={[48, 32]} className="relative">
        ...
        <Col span={24} className="relative z-10">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-1 space-y-6">
              <Card className="rounded-2xl border-slate-200 shadow-sm bg-white" bodyStyle={{ padding: '32px' }}>
        ...
        <Col span={24} className="relative z-10">
          <div className="flex items-start gap-8">
            ...
            <div className="flex-1 space-y-6">
              <Card className="rounded-2xl border-blue-200 shadow-md bg-white ring-1 ring-blue-100" bodyStyle={{ padding: '32px' }}>
