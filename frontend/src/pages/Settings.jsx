    ...
    <div className="p-4 md:p-8 space-y-6 bg-blue-50/50 min-h-full">
      ...
      <div className="max-w-6xl mx-auto">
        <Row gutter={[32, 32]}>
          ...
          <Col xs={24} lg={7} xl={6}>
            <Card 
              className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white h-full overflow-hidden" 
          ...
          <Col xs={24} lg={17} xl={18}>
            <Card 
              className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white min-h-[500px]" 
                  ...
                  <div>
                    ...
                    {twoFactorEnabled && (
                      <div className="animate-fade-in-up">
                        <Alert
                          message={<Text className="font-bold text-blue-900">Verification Setup Required</Text>}
                          description={
