    ...
    <div className="p-4 md:p-8 space-y-6 bg-slate-50 min-h-full">
      ...
      <Row gutter={[32, 32]}>
        ...
        <Col xs={24} lg={14} xl={15} className="space-y-6">
          ...
          <Card className="rounded-xl border border-slate-200 shadow-sm bg-white" bodyStyle={{ padding: '24px 32px' }}>
          ...
          <Card
            ...
            title={<Title level={4} className="!text-slate-900 !m-0">Submit Day 8 Progress</Title>}
        ...
        <Col xs={24} lg={10} xl={9}>
          <Card
            ...
            title={<Title level={4} className="!text-slate-900 !m-0">Validation Log</Title>}
            headStyle={{ borderBottom: '1px solid #f1f5f9', padding: '24px 32px 16px 32px', minHeight: 'auto' }}
          >
            <div className="pt-4">
              <Timeline
