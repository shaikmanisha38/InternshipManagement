  ...
  return (
    <div className="p-4 md:p-8 space-y-6 bg-blue-50/50 min-h-full">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        {/* Pending Tasks */}
        <Card className="rounded-2xl border-amber-200 shadow-sm shadow-blue-900/5 bg-white border-b-4" bodyStyle={{ padding: '20px' }}>
          <div className="flex items-center gap-3 mb-2">
        ...
        {/* Locked Tasks */}
        <Card className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-slate-50" bodyStyle={{ padding: '20px' }}>
          <div className="flex items-center gap-3 mb-2">
        ...
        {/* Missed Tasks */}
        <Card className="rounded-2xl border-red-200 shadow-sm shadow-blue-900/5 bg-red-50/30 border-l-4" bodyStyle={{ padding: '20px' }}>
          <div className="flex items-center gap-3 mb-2">
        ...
        {/* Average AI Score */}
        <Card className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-gradient-to-br from-blue-900 to-indigo-900 text-white" bodyStyle={{ padding: '20px' }}>
          <div className="flex items-center gap-3 mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card 
          className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white lg:col-span-2" 
          bodyStyle={{ padding: '24px' }}
          title={<Text className="text-slate-900 font-bold text-lg">Completion Velocity</Text>}
        ...
        <Card 
          className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white lg:col-span-1" 
          bodyStyle={{ padding: '24px' }}
          title={<Text className="text-slate-900 font-bold text-lg">Task Distribution</Text>}
          headStyle={{ borderBottom: '1px solid #f1f5f9', padding: '16px 24px', minHeight: 'auto' }}
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <Card 
          ...
          bodyStyle={{ padding: '24px' }}
          title={<div className="flex items-center gap-2"><GithubOutlined className="text-slate-800" /><Text className="text-slate-900 font-bold text-base">Git Commits</Text></div>}
          headStyle={{ borderBottom: '1px solid #f1f5f9', padding: '16px 24px', minHeight: 'auto' }}
        >
        ...
        <Card 
          className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white" 
          bodyStyle={{ padding: '24px' }}
          title={<Text className="text-slate-900 font-bold text-base">Score Trends</Text>}
          headStyle={{ borderBottom: '1px solid #f1f5f9', padding: '16px 24px', minHeight: 'auto' }}
        >
          <div className="h-[200px] w-full mt-2">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <Card 
          className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white" 
          bodyStyle={{ padding: '24px' }}
          title={<div className="flex items-center gap-2"><CalendarOutlined className="text-slate-800" /><Text className="text-slate-900 font-bold text-base">Attendance</Text></div>}
          headStyle={{ borderBottom: '1px solid #f1f5f9', padding: '16px 24px', minHeight: 'auto' }}
        >
