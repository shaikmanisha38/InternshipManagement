  ...
  return (
    <div className="p-4 md:p-8 space-y-6 bg-blue-50/50 min-h-full">
      ...
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        <Card
          className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white relative overflow-hidden"
          bodyStyle={{ padding: 0 }}
        >
          ...
          <div className="animate-fade-in-up space-y-6">
            ...
            <Row gutter={[24, 24]}>
              ...
              <Col xs={24} md={10} lg={8}>
                <Card className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white h-full" bodyStyle={{ padding: '32px 24px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
              ...
              <Col xs={24} md={14} lg={16}>
                <Card className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white h-full" bodyStyle={{ padding: '32px' }}>
                  <Title level={4} className="!text-slate-900 !m-0 !mb-6">Assessment Feedback</Title>

                  <Alert
                    message={<Text className="font-bold text-blue-900 text-base">Excellent Performance Overview</Text>}
