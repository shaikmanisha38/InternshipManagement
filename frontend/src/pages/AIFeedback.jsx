  ...
  return (
    <div className="p-4 md:p-8 space-y-6 bg-blue-50/50 min-h-full">
      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <Card className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white overflow-hidden relative" bodyStyle={{ padding: 0 }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {metrics.map((metric, idx) => (
            <Card key={idx} className="rounded-xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white hover:border-blue-300 transition-colors" bodyStyle={{ padding: '20px 16px' }}>
        ...
        <Row gutter={[24, 24]}>
          ...
          <Col xs={24} lg={12}>
            <Card 
              className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white h-full" 
              bodyStyle={{ padding: 0 }}
            >
          ...
          <Col xs={24} lg={12}>
            <Card 
              className="rounded-2xl border-slate-200 shadow-sm shadow-blue-900/5 bg-white h-full flex flex-col" 
              ...
              <div className="mb-6">
                <Timeline
                  ...
                  items={[
                    {
                      color: '#3b82f6',
                      children: <Text className="text-slate-700 font-medium"><Text className="font-bold text-slate-900">Step 1:</Text> Add comments where business logic is complex, specifically inside the `auth.middleware.js` file.</Text>,
                    },
                    {
                      color: '#3b82f6',
                      children: <Text className="text-slate-700 font-medium"><Text className="font-bold text-slate-900">Step 2:</Text> Avoid duplicate code segments by modularizing your error response payloads into a dedicated helper utility.</Text>,
                    },
                    {
                      color: '#8b5cf6',
                      children: <Text className="text-slate-700 font-medium"><Text className="font-bold text-slate-900">Step 3:</Text> Refactor variable names like `uDat` to `userData` for enhanced readability.</Text>,
                    }
                  ]}
                />
              </div>
